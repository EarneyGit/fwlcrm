// ============================================================
// FWL CRM CRM — Icons
// Lucide-based Icon System (Inline SVGs)
// ============================================================
...
LP.icons = (() => {
  const svgs = {
    ...
    'bar-chart-3': '<path d="M3 3v18h18"/><rect width="4" height="7" x="7" y="10" rx="1"/><rect width="4" height="12" x="15" y="5" rx="1"/>',
    ...
    'badge-indian-rupee': '<path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"/><path d="M8 8h8"/><path d="M8 12h8"/><path d="m13 17-5-5h1a4 4 0 0 0 0-8"/>',
    'message-circle': '<path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"/>'
  };

  /**
   * Returns an inline SVG string for the requested icon.
   * Uses currentColor so it inherits CSS color.
   */
